            ...
            <div class="thumbnail">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-muted"><?php echo e($article->category); ?></li>
                    </ol>
                </nav>
                <h1 class=""><?php echo e($article->title); ?></h1>
                <div class="d-flex mt-4">
                    <p class="text-muted me-2"><?php echo e($article->created_at->format('d M Y')); ?></p>
                    <p class="text-muted me-2">Oleh&nbsp;<?php echo e($article->user->name); ?></p>
                </div>
                <img src="<?php echo e(asset('storage/'.$article->image)); ?>" class="img-fluid w-100" alt="" style="height: 450px; object-fit: cover;">
                <div class="mt-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abdmalik1207/Balai/crud-articles/resources/views/home/show.blade.php ENDPATH**/ ?>